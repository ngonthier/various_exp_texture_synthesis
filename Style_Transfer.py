...
def get_vgg_layers(VGG19_mat='texturesyn_normalizedvgg.mat'):
	...
	if(VGG19_mat=='imagenet-vgg-verydeep-19.mat'):
		...
		try:
			...
			raise
	elif(VGG19_mat=='texturesyn_normalizedvgg.mat'): # Normalized VGG19 network over images (see Gatys Texture papers) generated by Gang with the Caffe model provide by Gatys
		try:
			vgg_rawnet = scipy.io.loadmat(VGG19_mat)
